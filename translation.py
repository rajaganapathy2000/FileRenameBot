class Translation(object):
    START_TEXT = """ <b> Hi {} , I'm A Simple File Renamer and File To Video Converter Bot With Permanent Thumbnail support!💯</b> \n

<b>Bot Maintained By: @SeriesDiscussionForum </b> \n 
<b> I Can Also Download/Upload Files From Zee5</b> \n
<b>Do /help for more Details ...</b> \n
"""

    RENAME_403_ERR = "What Are You Doing? Bro!!"
    BANNED_USER_TEXT = "Sorry!! But My Owner As Banned You From Using This Service. That Means You Can't Run Me Now! \n \n Contact : @Rajaganapathy2000 For more Details.. " 
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "**Thank you for Using Me SHARE > ❤️\n Join and Support us @SeriesDiscussionForum 🥰**"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds 🥳.\nUploaded in {} seconds 🥳"
    NOT_AUTH_USER_TEXT = "Contact @Rajaganapathy2000 "
    NOT_AUTH_USER_TEXT_FILE_SIZE = "IF You Got This Message You Should Contact @Rajaganapathy2000 "
    SAVED_CUSTOM_THUMB_NAIL = "<b>Thumbnail Saved ✅\nThis Is Permanent Until You Type</b> /delthumb ❤"
    ...
    CUSTOM_CAPTION_UL_FILE = " @SeriesDiscussionForum "
